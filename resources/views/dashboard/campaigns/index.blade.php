    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a class="font-semibold text-m text-gray-400 leading-tight bg-green-600 p-2 px-8 rounded text-white hover:bg-green-700 duration-200"
                href="{{ route('dashboard.campaigns.create') }}">{{ __('admin.add campaigns') }}</a>
        </div>
                                ...
                                @forelse ($campaigns as $campaign)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            {{-- <img width="100px" src="{{ asset($campaign->image->path) }}" alt=""> --}}
                                            <img class="w-24 h-16 object-cover rounded-md border"
                                                src="{{ asset($campaign->image->path ?? 'default/default-campaign.png') }}"
                                                alt="campaign image">

                                        </td>
                                        <td class="px-6 py-4 text-left font-medium">
                                            {{ $campaign->title_trans }}
                                        </td>
                                        <td class="px-6 py-4 text-center">
