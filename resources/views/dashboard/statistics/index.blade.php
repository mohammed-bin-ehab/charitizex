    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a class="font-semibold text-m text-gray-400 leading-tight bg-green-600 p-2 px-8 rounded text-white hover:bg-green-700 duration-200"
                href="{{ route('dashboard.statistics.create') }}">{{ __('admin.add statistics') }}</a>
        </div>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            <img class="w-24 h-16 object-cover rounded-md border"
                                                src="{{ asset($statistic->icon) }}" alt="statistic image">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                <!-- Delete Button -->
                                                <form
                                                    action="{{ route('dashboard.statistics.destroy', $statistic->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
