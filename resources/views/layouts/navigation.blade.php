        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-3 sm:-my-px sm:ms-4 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard.campaigns.index')" :active="request()->routeIs('dashboard.campaigns.index')">
                        {{ __('admin.campaigns') }}
                    </x-nav-link>
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white white:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
