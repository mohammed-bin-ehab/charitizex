...
<head>
    <meta charset="utf-8">
    <title>@yield('title', config('app.name' . app()->getLocale()))</title>
            ...
            <div class="col-lg-4 text-center text-lg-start">
                <a href="{{ route('dashboard') }}">
                    @isset($settings['site_logo'])
                        <img width="80" class="mt-1 w-24 h-16 object-cover rounded-md border"
                            src="{{ asset($settings['site_logo']) }}" alt="setting image">
                    @else
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="ms-2">
                                ...
                                <span class="text-white">{{ $settings['call_us'] ?? '+012 345 6789' }}</span>
                            </div>
                        </div>
                        {{-- @endisset --}}
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="ms-2">
                                ...
                                <span class="text-white">{{ $settings['mail_us'] ?? 'info@domain.com' }}</span>
                            </div>
                        </div>
                        {{-- @endisset --}}
                    </div>
                        ...
                        @isset($settings['address'])
                            <div class="d-flex justify-content-end">
                                ...
                                <div class="ms-2">
                                    ...
                                    <span class="text-white">{{ $settings['address'] ?? '123 Street, NY, USA' }}</span>
            ...
            <nav class="navbar navbar-expand-lg bg-primary navbar-dark px-4 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav {{ app()->getLocale() == 'ar' ? 'me-auto' : 'ms-auto' }}">
                        ...
                        <a href="{{ route('front.donations') }}" class="nav-item nav-link">Donation</a>
                        <a href="{{ route('front.events') }}" class="nav-item nav-link">Event</a>
                        <a href="{{ route('front.features') }}" class="nav-item nav-link">Feature</a>
                        <a href="{{ route('front.teams') }}" class="nav-item nav-link">Our Team</a>
                        <a href="{{ route('front.testimonials') }}" class="nav-item nav-link">Testimonial</a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        @foreach ($images as $image)
                            <div class="col-4">
                                <img class="img-fluid w-100" src="{{ asset($image->path ?? ' ') }}" alt="">
                                {{-- {{ asset(data_get($image, 'path', 'gallery-1.jpg')) }} --}}
                            </div>
                        @endforeach
                    </div>
                </div>
